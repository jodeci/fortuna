...
namespace :faker do
  ...
  task regular: :environment do
    e = Employee.create name: "Nao", start_date: "2015-05-13", role: "regular"
  ...
  task contractor: :environment do
    e = Employee.create name: "Hidetoshi", start_date: "2016-07-12", role: "contractor"
    ...
    e = Employee.create name: "Masaharu", start_date: "2017-02-05", role: "contractor"
    ...
    e = Employee.create name: "Teruyuki", start_date: "2017-02-05", role: "contractor"
    e.salaries.create monthly_wage: 20000, start_date: "2017-02-05", tax_code: "9a"
    e.payrolls.create year: 2017, month: 3

    e = Employee.create name: "Yusuke", start_date: "2017-02-05", role: "contractor"
  ...
  task parttime: :environment do
    e = Employee.create name: "Kazunari", start_date: "2016-01-20", role: "parttime"
    ...
    e = Employee.create name: "Masaki", start_date: "2016-01-20", role: "parttime"
